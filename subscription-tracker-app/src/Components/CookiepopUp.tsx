...
<Text style={S.label}>Nödvändiga cookies Dessa cookies är nödvändiga för att appen ska fungera korrekt. De hjälper till med att göra webbplatsen användbar genom att aktivera grundläggande funktioner som sidnavigering och åtkomst till säkra områden.{"\n"}
...
<Text style={S.label}>Funktionella cookies Dessa cookies gör det möjligt för appen att erbjuda utökade funktioner och personlig anpassning. De kan vara inställda av oss eller tredje parter vars tjänster vi har lagt till i appen.
