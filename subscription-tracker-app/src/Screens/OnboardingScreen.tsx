  ...
  return (
    <View style={styles.screenWrapper}>
      ...
      <View style={styles.textContainer}>
        ...
        {count <= 0 && (
          <Text>
            Välkommen till [Appens Namn]! Vi är glada att du är här. Med vår app
            kan du enkelt hantera alla dina prenumerationer och få en klar
        ...
        {count == 1 && (
          <Text>
            ...
            prenumeration du har. Vi hjälper dig att hålla koll på förfallodatum
            och kostnader.
          </Text>
        )}
